            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <ScrollReveal className="text-center mb-16 space-y-4">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white tracking-tight">
                        Invest in Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-white">Spiritual Growth</span>
                    </h1>
                            ...
                            <GlassCard className={`h-full flex flex-col relative p-8 ${tier.popular ? 'border-indigo-400/50 shadow-[0_0_40px_-10px_rgba(99,102,241,0.3)]' : ''}`}>
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="flex items-baseline gap-1 mb-2">
                                        ...
                                        {tier.period && <span className="text-slate-300 text-sm">{tier.period}</span>}
                                    </div>
                                ...
                                <button className={`w-full py-3 rounded-xl font-bold transition-all text-sm ${tier.popular
                                        ? 'bg-white text-indigo-950 hover:bg-indigo-50 shadow-lg shadow-indigo-500/20'
                ...
                <ScrollReveal className="mt-16 text-center">
                    <p className="text-slate-400 text-sm">
                        Questions about plans? <Link href="/contact" className="text-white underline hover:text-indigo-300 transition-colors">Contact us</Link>
                    </p>
                </ScrollReveal>
            </div>
        </div>
